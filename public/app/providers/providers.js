...
.provider('$languages', function() {
  var english = {
    ...
    table: {
      ...
      first_place_description: 'The author of the audition with the highest score at the end of the contest will win 1st place.',
      ...
      help_sharing_on: 'Help sharing on',
      hours: 'hours',
      cash_prizes_increase: 'Cash prizes increase according to the number of users.',
      ...
      second_place_description: 'The author of the audition with the second highest score at the end of the contest will win 2nd place.',
      ...
      third_place_description: 'The author of the audition with the third highest score at the end of the contest will win 3rd place.',
      this_audition_is_under_review_wait_for_approval: 'We are reviewing this audition, wait for approval.',
      this_contest_has_many_auditions: 'This contest has {{ totalAuditions }} auditions',
      ...
      forms: {
        ...
        email: 'Email',
        email_help: 'Want to use this email to receive our updates? If you choose another, we will send you a verification email and you can only use the main features after verify your email.',
  ...
  var portuguese = {
    ...
    table: {
      ...
      first_place_description: 'O autor da audição com a maior pontuação no final do concurso vencerá em primeiro lugar.',
      ...
      help_sharing_on: 'Ajude compartilhando no',
      hours: 'horas',
      cash_prizes_increase: 'Prêmios em dinheiro aumentam de acordo com o número de usuários.',
      ...
      like_us_on_facebook: 'Curta a nossa página no Facebook',
      ...
      second_place_description: 'O autor da audição com a segunda maior pontuação no final do concurso vencerá em segundo lugar.',
      ...
      third_place_description: 'O autor da audição com a terceira maior pontuação no final do concurso vencerá em terceiro lugar.',
      this_audition_is_under_review_wait_for_approval: 'Estamos revisando esta audição, espere pela aprovação.',
      this_contest_has_many_auditions: 'Esta competição tem {{ totalAuditions }} audições',
      ...
      forms: {
        ...
        email: 'Email',
        email_help: 'Deseja utilizar este email para receber nossas atualizações? Se você escolher outro, nós enviaremos um email de verificação e você só poderá utilizar as principais funcionalidades após verificar o seu email.',
