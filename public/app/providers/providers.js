...
.provider('$languages', function() {
  var english = {
    ...
    table: {
      ...
      hours: 'hours',
      incentive_vote_modal_description: 'Your votes are valid, but you can still vote for {{ remainingVotes }} other contestants. Help us to select the most talented people in this contest.',
      ...
      you_must_vote_in_at_least_two_contestants: 'You must vote in at least two competitors to have your votes counted.',
      you_participated: 'You participated!',
      you_voted: 'You voted!',
      your_audition: 'Your audition',
      your_votes: 'Your votes',
      your_vote_is_not_valid_yet: 'Your vote is not valid yet!',
      alerts: {
      ...
      errors: {
        ...
        audition_vote_reach_maximum_votes: 'You reach the maximum of votes per contest.',
  ...
  var portuguese = {
    ...
    table: {
      ...
      hours: 'horas',
      incentive_vote_modal_description: 'Seu voto é válido, mas você ainda pode votar em mais {{ remainingVotes }} competidores. Ajude-nos a selecionar as pessoas mais talentosas da competição.',
      ...
      you_must_vote_in_at_least_two_contestants: 'Você precisa votar em ao menos dois competidores para ter seus votos contabilizados.',
      you_participated: 'Você participou!',
      you_voted: 'Você votou!',
      your_audition: 'Sua audição',
      your_votes: 'Seus votos',
      your_vote_is_not_valid_yet: 'Seu voto ainda não é válido!',
      alerts: {
      ...
      errors: {
        ...
        audition_vote_reach_maximum_votes: 'Você alcançou o máximo de votos por competição.',
