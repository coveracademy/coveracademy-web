...
.provider('$languages', function() {
  var english = {
    ...
    table: {
      ...
      see_the_random_auditions: 'See the random auditions',
      see_the_top_rated_auditions: 'See the top rated auditions',
  ...
  var portuguese = {
    ...
    table: {
      ...
      see_the_randomly_auditions: 'Veja as audições aleatóriamente',
      see_the_top_rated_auditions: 'Veja as audições mais votadas',
