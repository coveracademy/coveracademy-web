...
.provider('$languages', function() {
  var english = {
    ...
    table: {
      ...
      by_user: 'by',
      comment: 'Comment',
      companies_that_are_supporting_contests: 'Companies that are supporting the contests',
      ...
      minutes: 'minutes',
      more_contestants: 'More contestants',
      ...
      remaining_contestants: 'Remaining more {{ value }} auditions to start',
  ...
  var portuguese = {
    ...
    table: {
      ...
      by_user: 'por',
      comment: 'Comentar',
      companies_that_are_supporting_contests: 'Empresas que estão apoiando as competições',
      ...
      minutes: 'minutos',
      more_contestants: 'Mais competidores',
      ...
      remaining_contestants: 'Faltam mais {{ value }} audições para começar',
