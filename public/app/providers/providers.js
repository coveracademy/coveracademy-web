...
.provider('$languages', function() {
  var english = {
    ...
    table: {
      ...
      join_now: 'Join now!',
      lets_create_the_largest_community: 'Let\'s create the largest music lovers community?',
  ...
  var portuguese = {
    ...
    table: {
      ...
      lets_create_the_largest_community: 'Vamos criar a maior comunidade de amantes da música?',
