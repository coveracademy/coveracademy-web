...
.provider('$languages', function() {
  var english = {
    ...
    table: {
      ...
      you_can_vote_in_more_contestants: 'You can vote in more {{ remainingVotes }} contestants',
  ...
  var portuguese = {
    ...
    table: {
      ...
      you_can_vote_in_more_contestants: 'Você pode votar em mais {{ remainingVotes }} competidores',
