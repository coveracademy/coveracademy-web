...
.provider('$languages', function() {
  var english = {
    ...
    table: {
      ...
      you_must_vote_in_at_least_two_contestants: 'You must vote in at least two competitors to validate your first vote.',
  ...
  var portuguese = {
    ...
    table: {
      ...
      you_must_vote_in_at_least_two_contestants: 'Você precisa votar em no mínimo dois competidores para validar o seu primeiro voto.',
