...
.provider('$languages', function() {
  var english = {
    ...
    table: {
      ...
      you_must_vote_in_at_least_two_contestants: 'You need to vote for another competitor to validate your vote.',
  ...
  var portuguese = {
    ...
    table: {
      ...
      you_must_vote_in_at_least_two_contestants: 'Você precisa votar em mais um competidor para validar o seu voto.',
      you_participated: 'Você participou!',
      you_voted: 'Você votou!',
      your_audition: 'Sua audição',
      your_votes: 'Seus votos',
      your_vote_is_not_valid_yet: 'Seu voto ainda não está valendo!',
      alerts: {
