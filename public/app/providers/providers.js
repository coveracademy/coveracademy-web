...
.provider('$languages', function() {
  ...
  var portuguese = {
    ...
    table: {
      ...
      music_genre_artists: 'Artistas {{ name }}',
      musics: 'musicas',
      ...
      see_all_music_genre_artists: 'Veja todos os artistas {{ name }}',
      see_the_best_covers: 'Veja os melhores covers',
      see_the_best_music_genre_covers: 'Veja os melhores covers {{ name }}',
      see_the_latest_covers: 'Veja os últimos covers',
      see_the_latest_music_genre_covers: 'Veja os últimos covers {{ name }}',
      ...
      the_best_music_genre_covers: 'Os melhores covers {{ name }}',
      the_cover_author: 'O autor do cover',
      the_latest_music_genre_covers: 'Os últimos covers {{ name }}',
