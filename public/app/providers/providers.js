...
.provider('$languages', function() {
  ...
  var portuguese = {
    ...
    table: {
      ...
      back_to_the_contest_page: 'Volte para a página do campeonato',
      be_the_first_to_join_the_contest: 'Seja o primeiro a entrar no campeonato!',
      ...
      days: 'dias',
      contest_finished: 'Campeonato finalizado',
      follow_us: 'Siga-nos',
      ...
      see_the_latest_auditions: 'Veja as melhores audições',
      ...
      this_contest_was_finished: 'Este campeonato acabou!',
      ...
      winners: 'Vencedores',
      you_are_already_in_the_contest: 'Você já está no concurso',
      ...
      errors: {
        ...
        join_contest_video_date_is_not_valid: 'O vídeo não pode ser mais antigo ou novo do que o concurso',
