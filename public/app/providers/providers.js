...
.provider('$languages', function() {
  var english = {
    ...
    image: 'en.png',
    table: {
      account_confirmed: 'Your account was confirmed successfully, now you can vote and enter the contest.',
      add_cover: 'Add cover',
      ...
      forms: {
        ...
        confirm: 'Confirm',
        edit_email_help: 'If you change this email, we will send you a confirmation email and you can only use the main features after confirming your account again.',
        edit_username_help: 'This name can be defined only once. If you fill now, you can not change later.',
        email: 'Email',
        email_help: 'Want to use this email to receive our updates? If you choose another, we will send you a confirmation email and you can only use the main features after confirming your account.',
  ...
  var portuguese = {
    ...
    image: 'pt-br.png',
    table: {
      account_confirmed: 'Sua conta foi confirmada com sucesso, agora você pode votar e participar da competição.',
      ...
      forms: {
        ...
        confirm: 'Confirmar',
        edit_email_help: 'Se você alterar este email, nós enviaremos um email de confirmação e você só poderá utilizar as principais funcionalidades após confirmar novamente a sua conta.',
        edit_username_help: 'Este nome só pode ser definido uma vez. Se você preencher agora, não poderá alterar posteriormente.',
        email: 'Email',
        email_help: 'Deseja utilizar este email para receber nossas atualizações? Se você escolher outro, nós enviaremos um email de confirmação e você só poderá utilizar as principais funcionalidades após confirmar a sua conta.',
