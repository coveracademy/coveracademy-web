...
.provider('$languages', function() {
  var english = {
    ...
    table: {
      ...
      winners: 'Winners',
      wons_a_gold_medal: 'wons a <span class="label label-gold">Gold</span> medal',
      wons_a_silver_medal: 'wons a <span class="label label-silver">Silver</span> medal',
      wons_a_bronze_medal: 'wons a <span class="label label-bronze">Bronze</span> medal',
  ...
  var portuguese = {
    ...
    table: {
      ...
      first_place_description: 'O autor da audição com o maior pontuação no final do concurso vencerá em primeiro lugar. O prêmio em dinheiro aumentará com a entrada de novos competidores.',
      follow_us: 'Siga-nos',
      ...
      join_contest_paste_video_url: 'Pronto, agora você só precisa colar a URL do vídeo do YouTube abaixo!',
      ...
      second_place_description: 'O autor da audição com o segundo maior pontuação no final do concurso vencerá em segundo lugar. O prêmio em dinheiro aumentará com a entrada de novos competidores.',
      ...
      third_place_description: 'O autor da audição com o terceiro maior pontuação no final do concurso vencerá em terceiro lugar. O prêmio em dinheiro aumentará com a entrada de novos competidores.',
      ...
      winners: 'Vencedores',
      wons_a_gold_medal: 'ganhou uma medalha de <span class="label label-gold">Ouro</span>',
      wons_a_silver_medal: 'ganhou uma medalha de <span class="label label-silver">Prata</span>',
      wons_a_bronze_medal: 'ganhou uma medalha de <span class="label label-bronze">Bronze</span>',
